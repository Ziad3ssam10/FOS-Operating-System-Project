...
/*2024*/
#define CONS_LCK_METHOD LCK_SEMAPHORE	//Specify the method of LOCK to protect the console
...
#define KBD_INT_BLK_METHOD LCK_SEMAPHORE	//Specify the method of handling the block/release on KBD
